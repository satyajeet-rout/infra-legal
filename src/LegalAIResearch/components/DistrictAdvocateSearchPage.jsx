...
//     try {
//       const response = await fetch("https://infrahive-ai-legal-research-gyfsavdfd0c9ehh5.centralindia-01.azurewebsites.net/legal-infrahive/district-court/search/advocate-name/", {
//         method: 'POST',
//         headers: {
...
//         (caseItem.advocate && caseItem.advocate.toLowerCase().includes(query)) ||
//         (caseItem.filing && 
...
//             Search {court.charAt(0).toUpperCase() + court.slice(1)} Court by Advocate Name
//           </h2>
...
//         required
//       />
//       <div className="text-xs text-gray-500 mt-1">Example: PRATEEK</div>
//     </div>
...
//                               {/* Display full advocate name with priority to API response, then search input */}
//                               {caseItem.advocateName || caseItem.advocate || name || 'N/A'}
//                             </td>
//                             <td className="px-4 py-3 text-sm text-gray-900">
