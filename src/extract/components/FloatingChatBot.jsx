...
//           <img src="https://infrahive-ai-search.vercel.app/Logo%20(Digest).png" alt="Logo" className="h-8 z-20" />
...
import React, { useState, useEffect, useRef } from 'react';
import { ChevronRight, MessageCircle, Send, X, Loader2, Download } from 'lucide-react';
import { createPortal } from 'react-dom';
          ...
          children: [
            ...
            ...response.split('\n').map(line => {
              ...
              return new Paragraph({
                children: segments.length > 0 ? segments : [new TextRun({ text: line, size: 24 })],
              });
            }),
          ],
        }],
          ...
          children: [
            ...
            ...citations.map((citation, index) => [
              new Paragraph({
                ...
                children: [
                  new TextRun({
                    text: `Citation ${index + 1} (Page ${citation.page_number})`,
                    bold: true,
                    size: 24,
                  }),
                ],
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { 
        type: 'bot', 
        content: formatBotResponse(data.response, data.citations, inputMessage),
        ...
        {citations && citations.length > 0 && (
          <div className="mt-4">
            <div className="flex items-center justify-between mb-2">
              <strong>Citations:</strong>
              <button
                onClick={() => handleDownload(inputMessage, response, citations)}
